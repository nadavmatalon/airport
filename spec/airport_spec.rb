...
describe Airport do
	...
	def stormy_conditions
		...
		airport.set_weather_to :stormy and airport.update_status
	end
	...
	context "landing & sending off planes management:" do
		...
		it "throws an error if \'send_off\' method is used with no argument" do
			sunny_conditions
			expect{ airport.send_off }.to raise_error
		end
	end	
